    ...
    <div className="flex">
      ...
      <div className="w-[1000px] mx-auto mt-10 justify-center">
        ...
        <div className="w-[1000px] bg-bgTri mx-auto mt-5 justify-center rounded-md shadow-sm shadow-textFunc">
          <div className="h-10 bg-bgOpt rounded-t-md text-textOpt py-[10px] px-5 font-bold"> DATA PRIBADI</div>
          <div className="p-5">
          ...
          <div className="h-10 bg-bgOpt rounded-t-md text-textOpt py-[10px] px-5 font-bold"> DATA KONSULTASI</div>
          <div className="p-5">
            <div className="flex-1">
              <div className="w-full ">
                <form onSubmit={handleSubmit} className="space-y-4">
...
export default CreatePaymentAdmin;
